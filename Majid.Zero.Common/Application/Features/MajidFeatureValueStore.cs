...
namespace Majid.Application.Features
{
    ...
    /// </summary>
    public class MajidFeatureValueStore<TTenant, TUser> :
        IMajidZeroFeatureValueStore,
        ...
        where TUser : MajidUserBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MajidFeatureValueStore{TTenant, TUser}"/> class.
        /// </summary>
        public MajidFeatureValueStore(
