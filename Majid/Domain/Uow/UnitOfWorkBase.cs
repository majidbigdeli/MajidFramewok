...
namespace Majid.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// </summary>
        public IMajidSession MajidSession { protected get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(MajidSession.TenantId, false);
        ...
        public virtual IDisposable SetTenantId(int? tenantId, bool switchMustHaveTenantEnableDisable)
        {
            ...
            if (switchMustHaveTenantEnableDisable)
            {
                mustHaveTenantEnableChange = tenantId == null
                    ? DisableFilter(MajidDataFilters.MustHaveTenant)
                    : EnableFilter(MajidDataFilters.MustHaveTenant);
            }
            else
            {
            ...
            var mayHaveTenantChange = SetFilterParameter(MajidDataFilters.MayHaveTenant, MajidDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(MajidDataFilters.MustHaveTenant, MajidDataFilters.Parameters.TenantId, tenantId ?? 0);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new MajidException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new MajidException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            if (MajidSession.TenantId == null)
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, MajidDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new MajidException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
