...
namespace Majid.MultiTenancy
{
    /// <summary>
    /// Tenant manager.
    /// Implements domain logic for <see cref="MajidTenant{TUser}"/>.
    /// </summary>
    ...
    public class MajidTenantManager<TTenant, TUser> : IDomainService,
    ...
    {
        public MajidEditionManager EditionManager { get; set; }
        ...
        private readonly IMajidZeroFeatureValueStore _featureValueStore;

        public MajidTenantManager(
            IRepository<TTenant> tenantRepository, 
            IRepository<TenantFeatureSetting, long> tenantFeatureRepository,
            MajidEditionManager editionManager,
        ...
        public virtual async Task<TTenant> GetByIdAsync(int id)
        {
            ...
            if (tenant == null)
            {
                throw new MajidException("There is no tenant with id: " + id);
            }
        ...
        {
            if (!Regex.IsMatch(tenancyName, MajidTenant<TUser>.TenancyNameRegex))
            {
