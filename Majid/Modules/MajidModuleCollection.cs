...
namespace Majid.Modules
{
    ...
    /// </summary>
    internal class MajidModuleCollection : List<MajidModuleInfo>
    {
        public Type StartupModuleType { get; }

        public MajidModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : MajidModule
        {
            var module = this.FirstOrDefault(m => m.Type == typeof(TModule));
            if (module == null)
            {
                throw new MajidException("Can not find module for " + typeof(TModule).FullName);
            }
        ...
        public List<MajidModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<MajidModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(MajidKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<MajidModuleInfo> modules, Type startupModuleType)
        {
