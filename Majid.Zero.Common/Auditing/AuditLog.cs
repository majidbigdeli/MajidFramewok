...
namespace Majid.Auditing
{
    ...
    public class AuditLog : Entity<long>, IMayHaveTenant
    {
        ...
        {
            var exceptionMessage = GetMajidClearException(auditInfo.Exception);
            return new AuditLog
                   {
        ...
        /// <returns></returns>
        public static string GetMajidClearException(Exception exception)
        {
            var clearMessage = "";
            switch (exception)
            {
                ...
                case MajidValidationException majidValidationException:
                    clearMessage = "There are " + majidValidationException.ValidationErrors.Count + " validation errors:";
                    foreach (var validationResult in majidValidationException.ValidationErrors) 
                    {
                        var memberNames = "";
