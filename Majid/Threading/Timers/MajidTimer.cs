...
namespace Majid.Threading.Timers
{
    /// <summary>
    ...
    public class MajidTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public MajidTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new MajidException("Period should be set before starting the timer!");
            }
