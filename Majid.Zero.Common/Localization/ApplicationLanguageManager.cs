...
namespace Majid.Localization
{
        ...
        ISingletonDependency
    {
        ...
        /// </summary>
        public const string CacheName = "MajidZeroLanguages";
        ...
        public virtual async Task AddAsync(ApplicationLanguage language)
        {
            ...
            {
                throw new MajidException("There is already a language with name = " + language.Name);
            }
        ...
        public virtual async Task RemoveAsync(int? tenantId, string languageName)
        {
            ...
            {
                throw new MajidException("Can not delete a host language from tenant!");
            }
        ...
        public virtual async Task UpdateAsync(int? tenantId, ApplicationLanguage language)
        {
            ...
            {
                throw new MajidException("Can not update a host language from tenant");
            }
        ...
        public void HandleEvent(EntityChangedEventData<ApplicationLanguage> eventData)
        {
            ...
            _cacheManager.GetCache("MajidLocalizationScripts").Clear();
        }
