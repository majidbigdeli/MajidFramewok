...
namespace Majid.Authorization
{
        ...
        where TUser : MajidUser<TUser>
    {
        ...
        /// Constructor.
        /// </summary>
        protected PermissionChecker(MajidUserManager<TRole, TUser> userManager)
        {
        ...
        {
            return MajidSession.UserId.HasValue && await _userManager.IsGrantedAsync(MajidSession.UserId.Value, permissionName);
        }
