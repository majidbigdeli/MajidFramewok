...
namespace Majid.Configuration
{
    ...
    public static class CacheManagerSettingExtensions
    {
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(MajidCacheNames.ApplicationSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<int, Dictionary<string, SettingInfo>>(MajidCacheNames.TenantSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(MajidCacheNames.UserSettings);
        }
    }
}
