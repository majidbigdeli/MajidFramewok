...
{
    public class MajidLogInManager<TTenant, TRole, TUser> : ITransientDependency
        ...
        where TUser : MajidUser<TUser>
    {
        ...
        private readonly MajidUserClaimsPrincipalFactory<TUser, TRole> _claimsPrincipalFactory;

        public MajidLogInManager(
            ...
            MajidUserClaimsPrincipalFactory<TUser, TRole> claimsPrincipalFactory)
        {
        ...
        protected virtual async Task<MajidLoginResult<TTenant, TUser>> LoginAsyncInternal(string userNameOrEmailAddress, string plainPassword, string tenancyName, bool shouldLockout)
        {
            ...
            using (UnitOfWorkManager.Current.SetTenantId(tenantId))
            {
                ...
                //TryLoginFromExternalAuthenticationSources method may create the user, that's why we are calling it before MajidUserStore.FindByNameOrEmailAsync
        ...
        protected virtual async Task<MajidLoginResult<TTenant, TUser>> CreateLoginResultAsync(TUser user, TTenant tenant = null)
        {
            ...
            {
                return new MajidLoginResult<TTenant, TUser>(MajidLoginResultType.UserPhoneNumberIsNotConfirmed);
            }
