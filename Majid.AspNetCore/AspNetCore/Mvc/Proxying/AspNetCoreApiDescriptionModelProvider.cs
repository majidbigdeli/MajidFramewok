...
using Majid.AspNetCore.Mvc.Proxying.Utils;
...
namespace Majid.AspNetCore.Mvc.Proxying
{
    public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ISingletonDependency
    {
        ...
        private readonly MajidAspNetCoreConfiguration _configuration;
        ...
        public AspNetCoreApiDescriptionModelProvider(
            ...
            MajidAspNetCoreConfiguration configuration,
        ...
        private string GetModuleName(ApiDescription apiDescription)
        {
            ...
            {
                return MajidControllerAssemblySetting.DefaultServiceModuleName;
            }
