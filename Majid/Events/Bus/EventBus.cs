...
using Majid.Events.Bus.Factories;
using Majid.Events.Bus.Factories.Internals;
using Majid.Events.Bus.Handlers;
using Majid.Events.Bus.Handlers.Internals;
using Majid.Extensions;
using Majid.Threading;
using Majid.Threading.Extensions;
using Castle.Core.Logging;

namespace Majid.Events.Bus
{
    /// <summary>
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new MajidException(message));
                    }
                }
            }
