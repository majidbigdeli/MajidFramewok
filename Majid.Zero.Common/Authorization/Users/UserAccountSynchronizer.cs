...
namespace Majid.Authorization.Users
{
    ...
    public class UserAccountSynchronizer :
        IEventHandler<EntityCreatedEventData<MajidUserBase>>,
        IEventHandler<EntityDeletedEventData<MajidUserBase>>,
        IEventHandler<EntityUpdatedEventData<MajidUserBase>>,
        ITransientDependency
    {
        ...
        /// </summary>
        [UnitOfWork]
        public virtual void HandleEvent(EntityCreatedEventData<MajidUserBase> eventData)
        {
        ...
        [UnitOfWork]
        public virtual void HandleEvent(EntityDeletedEventData<MajidUserBase> eventData)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
                var userAccount =
        ...
        /// <param name="eventData"></param>
        [UnitOfWork]
        public virtual void HandleEvent(EntityUpdatedEventData<MajidUserBase> eventData)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
