...
using Majid.ObjectMapping;
using Majid.Runtime.Session;
using Majid.Web.Mvc.Alerts;
using Castle.Core.Logging;
using Microsoft.AspNetCore.Mvc.RazorPages;

namespace Majid.AspNetCore.Mvc.RazorPages
{
    /// <summary>
    /// Base class for all MVC Controllers in Majid system.
    /// </summary>
    public abstract class MajidPageModel : PageModel, ITransientDependency
    {
        /// <summary>
        ...
        protected ILocalizationSource LocalizationSource
        {
            get
            {
                ...
                {
                    throw new MajidException("Must set LocalizationSourceName before, in order to get LocalizationSource");
                }
        ...
        public IUnitOfWorkManager UnitOfWorkManager
        {
            get
            {
                ...
                {
                    throw new MajidException("Must set UnitOfWorkManager before use it.");
                }
