...
namespace Majid.Authorization.Users
{
    ...
    /// </summary>
    [Table("MajidUsers")]
    public abstract class MajidUserBase : FullAuditedEntity<long>, IMayHaveTenant, IPassivable
    {
        /// <summary>
        ...
        /// <summary>
        /// Is the <see cref="MajidUserBase.EmailAddress"/> confirmed.
        /// </summary>
