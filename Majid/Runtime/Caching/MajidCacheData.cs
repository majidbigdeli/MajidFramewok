...
namespace Majid.Runtime.Caching
{
    ...
    public class MajidCacheData
    {
        ...
        public static MajidCacheData Deserialize(string serializedCacheData) => serializedCacheData.FromJsonString<MajidCacheData>();

        public static MajidCacheData Serialize(object obj)
        {
            return new MajidCacheData(
