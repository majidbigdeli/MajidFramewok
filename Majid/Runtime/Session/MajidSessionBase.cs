...
{
    public abstract class MajidSessionBase : IMajidSession
    {
        public const string SessionOverrideContextKey = "Majid.Runtime.Session.Override";
        ...
        protected MajidSessionBase(IMultiTenancyConfig multiTenancy, IAmbientScopeProvider<SessionOverride> sessionOverrideScopeProvider)
        {
