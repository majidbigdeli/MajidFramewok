...
namespace Majid.Authorization
{
    ...
    public static class PermissionCheckerExtensions
    {
        ...
        /// throws <see cref="MajidAuthorizationException"/> if not authorized.
        ...
        /// <exception cref="MajidAuthorizationException">Throws authorization exception if</exception>
        ...
        public static string L(IPermissionChecker permissionChecker, string name, string defaultValue)
        {
            ...
            {
                return localizationManager.Object.GetString(MajidConsts.LocalizationSourceName, name);
            }
        }
