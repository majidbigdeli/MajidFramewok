    ...
    public class JsonFileLocalizationDictionaryProvider : LocalizationDictionaryProviderBase
    {
        ...
        public override void Initialize(string sourceName)
        {
            ...
            foreach (var fileName in fileNames)
            {
                ...
                {
                    throw new MajidInitializationException(sourceName + " source contains more than one dictionary for the culture: " + dictionary.CultureInfo.Name);
                }
                ...
                if (fileName.EndsWith(sourceName + ".json"))
                {
                    ...
                    {
                        throw new MajidInitializationException("Only one default localization dictionary can be for source: " + sourceName);
                    }
